...
f_ecg = 1.5;   % Approximate ECG frequency (Hz)
 
% Generate a synthetic ECG signal (sum of sinusoidals)
ecg_signal = sin(2*pi*f_ecg*t) + 0.2*sin (2*pi*50*t) + 0.1*randn(size(t));
